...
var exception = "";
var 내경편_권02 = {"말": {}, "진액(津液)": {}, "담음(痰飮)": {}};
// 책 내용을 대략적으로 살펴보면서 스크래핑 하기 위해 하드 코딩
const 내경편_권02_목차 = ["말", "진액(津液)", "담음(痰飮)"];
...
async function inside_view_02_B() {
    try {
        ...
        for (i1 = 673; i1 <= 1410; i1++) {
            const response = await axios.get("https://mediclassics.kr/books/8/volume/2/content?up_content_seq=" + i1);
